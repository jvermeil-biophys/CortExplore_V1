...
date = '22-07-06 & 22-06-16 & 22-06-10 & 22-07-12 & 22-07-22'
dba.computeGlobalTable_meca(task = date, fileName = 'Global_MecaData_DB', 
                            save = True, PLOT = True, source = 'Python') # task = 'updateExisting'
...
#     print(GlobalTable_meca.columns.values)

# %% Cell counting (DB)

# Option 1
group1 = GlobalTable_meca.groupby(['date', 'substrate'])
countDf1 = group1.agg('count')['cellID']

# Option 2
# group2 = GlobalTable_meca.groupby(['date', 'substrate', 'cellID'])
# countDf2 = group2.agg('count')['compNum']


# Option 3
group3 = GlobalTable_meca.groupby(['substrate'])
countDf3 = group3.agg('count')['cellID']

group4 = GlobalTable_meca[GlobalTable_meca['validatedFit_S=300+/-75']==True].groupby(['substrate'])
countDf4 = group4.agg('count')['cellID']

group5 = GlobalTable_meca[GlobalTable_meca['validatedFit_S=300+/-75']==True].groupby(['substrate', 'cellID'])
countDf5 = group5.agg('count')['compNum']


data = GlobalTable_meca
data_f = data[data['validatedFit_S=300+/-75']==True]
countDf6 = data_f.groupby("substrate").agg({"compNum": 'count', "cellID": pd.Series.nunique})

# %% Data import & export (others)

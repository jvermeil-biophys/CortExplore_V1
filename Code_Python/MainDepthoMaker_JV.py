...
if COMPUTERNAME == 'ORDI-JOSEPH':
    mainDir = "C://Users//JosephVermeil//Desktop//CortExplore"
    dataDir = "D://MagneticPincherData//Raw"
elif COMPUTERNAME == 'LARISA':
    mainDir = "C://Users//Joseph//Desktop//CortExplore"
    dataDir = "D://MagneticPincherData//Raw"
elif COMPUTERNAME == '':
    mainDir = "C://Users//josep//Desktop//CortExplore"
    dataDir = "D://MagneticPincherData//Raw"
...
subdir = 'M1'
depthoPath = os.path.join(dataDir, date + '_Deptho', subdir)
savePath = os.path.join(dataDir, 'EtalonnageZ')
...
subdir = 'Depthos'
depthoPath = os.path.join(dataDir, date + '_CalibrationM450-2023_SecondTry', subdir)
savePath = os.path.join(dataDir, 'EtalonnageZ')
...
subdir = 'Depthos'
depthoPath = os.path.join(dataDir, date + '_CalibrationM450-2023_FirstTry', subdir)
savePath = os.path.join(dataDir, 'EtalonnageZ')
